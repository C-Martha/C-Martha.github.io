      ...
      <div>
        ...
        <Card className="card">
          ...
          <ExperienceComponent
            ...
            description="While interning at SoFriendly I had the chance to work on building websites using Webflow and Wordpress for clients. Aside from the design and technical skills that I learn during my intership at SoFriendly, another big take away was becoming a more confident developer thanks to the support and motivation from the team." />
        </Card>
